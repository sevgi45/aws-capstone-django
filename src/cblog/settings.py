...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/sevgi/capstone/username')
    password_param = ssm.get_parameter(Name="/sevgi/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-database.crqjmjlvif03.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'sevgicapstonestatic' # please enter your s3 bucket name
